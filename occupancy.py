...
train=pd.read_csv("F:\DBDA\Project\Date16dec2020maildata\datatraining.txt")
train['date']=pd.to_datetime(train['date']) #convert date time into python datetime
train.reset_index(drop=True,inplace=True)

Validation=pd.read_csv("F:\DBDA\Project\Date16dec2020maildata\datatest.txt")
Validation['date']=pd.to_datetime(Validation['date']) #convert date time into python datetime
Validation.reset_index(drop=True,inplace=True)

test=pd.read_csv("F:\DBDA\Project\Date16dec2020maildata\datatest2.txt")
